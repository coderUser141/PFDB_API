    ...
    namespace ParsingUtility{
        ...
        public static class ParseTesting{
            ...
            public static bool Test(){
                ...
                if(IndexSearchNoOccurencesTest())score++;
                if(CorruptedWordFixTest())score++;
                if(StatisticParseMatchTest())score++;
            ...
            public static bool IndexSearchSingleWordTest(){
            ...
            /// </summary>
            /// <returns>Whether this test passes.</returns>
            public static bool IndexSearchSingleCharacterTest(){
                IIndexSearch testing1 = new IndexSearch(
            ...
            /// </summary>
            /// <returns>Whether this test passes.</returns>
            public static bool IndexSearchNoOccurencesTest(){
                IIndexSearch testing1 = new IndexSearch(
                    "the quick brown fox jumps over the lazy dog",
                    "1");
                StringBuilder builder = new StringBuilder();
            ...
            /// <summary>
            /// Tests if <see cref="StatisticParse._corruptedWordFixer(string?)"/> can fix a word spelt wrong (common from PyTesseract scans). 
            /// </summary>
            /// <returns>Whether this test passes.</returns>
            public static bool CorruptedWordFixTest()
			{
				StatisticParse AN94 = new StatisticParse(new WeaponIdentification(new PhantomForcesVersion("10.0.1"), Categories.AssaultRifles, 11, 0, "AN-94"),sampleText);
                string corruptedWord = AN94._corruptedWordFixer("CAPACITY");
            ...
            /// <summary>
            /// Tests if <see cref="StatisticParse.FindStatisticInFile(SearchTargets, IEnumerable{char})"/> can successfully detect and add a statistic from a file.
            /// </summary>
            /// <returns>Whether this test passes.</returns>
            public static bool StatisticParseMatchTest(){
				StatisticParse AN94 = new StatisticParse(new WeaponIdentification(new PhantomForcesVersion("10.0.1"), Categories.AssaultRifles, 11, 0, "AN-94"), sampleText);
				SearchTargets target = SearchTargets.WeaponWalkspeed;
                try{
                    string stat = AN94.FindStatisticInFile(target, ['\n','\r']);
					PFDBLogger.LogDebug($"Successfully added test statistic ({stat}) to StatisticParse object.");
                    return true;
                }catch(ArgumentException){
                    PFDBLogger.LogDebug($"Test statistic ({target}) was not added to StatisticParse object.");
                    return false;
            ...
            /// </summary>
            /// <returns>Whether this test passes.</returns>
            public static bool FileParseCompleteTest(){
                WeaponIdentification AN94 = new WeaponIdentification(new PhantomForcesVersion("10.0.1"), Categories.AssaultRifles, 11, 0, "AN-94");
                FileParse AN94parse = new FileParse(AN94, sampleText);

                StatisticCollection collection = (StatisticCollection)AN94parse.FindAllStatisticsInFileWithTypes();
                int score = 0;
