...
{
	/// <summary>
	/// Defines an enumerator for statistics that can be found 
	/// </summary>
	public enum StatisticOptions
	{
		...
		/// <summary>
		/// Total ammo capacity. Only for guns.
		/// </summary>
		TotalAmmoCapacity,

		/// <summary>
		/// Magazine capacity. How many bullets the magazine/clip can carry. Only for guns.
		/// </summary>
		MagazineCapacity,

		/// <summary>
		/// Reserve capacity. How many bullets are in reserve. Only for guns.
		/// </summary>
		ReserveCapacity,
