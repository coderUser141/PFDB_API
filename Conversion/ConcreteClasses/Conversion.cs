...
namespace PFDB.Conversion
{
	...
	public class Conversion : IConversion
	{
		...
		/// Invokes <see cref="IFileParse.FileReader(string)"/> to open the file, and <see cref="IFileParse.FindAllStatisticsInFileWithTypes(int, int, bool)"/> to extract the statistics.
		/// </summary>
		...
		public Conversion(string filepath, WeaponIdentification weaponID)
		{
			...
			_statisticCollection = fileToBeParsed.FindAllStatisticsInFileWithTypes();
		...
		/// Invokes <see cref="IFileParse.FindAllStatisticsInFileWithTypes(int, int, bool)"/> to extract the statistics.
		/// </summary>
